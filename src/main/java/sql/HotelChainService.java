...
public class HotelChainService {
    ...
    public List<HotelChain> getHotelChain() throws Exception {
        ...
        // sql query
        String sql = "SELECT * FROM CSI2132Project.HotelChain";
    ...
    public String createHotelChain(HotelChain hotelChain) throws Exception {
        ...
        try {
            ...
            message = "Error while inserting sql.HotelChain: " + e.getMessage();
        } finally {
            if (con != null) // if connection is still open, then close.
                con.close();
            if (message.equals("")) message = "sql.HotelChain successfully inserted!";
    ...
    public String updateHotelChain(HotelChain hotelChain) throws Exception {
        ...
        try {
            ...
            message = "Error while updating sql.HotelChain: " + e.getMessage();

        } finally {
            if (con != null) con.close();
            if (message.equals("")) message = "sql.HotelChain successfully updated!";
        }
